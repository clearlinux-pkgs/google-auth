...
Source0  : https://files.pythonhosted.org/packages/71/e5/a0017ceb8a096e2197360452299fef4c70bedeb840b1af73170c5c9d843d/google-auth-1.20.0.tar.gz
...
%prep
%setup -q -n google-auth-1.20.0
cd %{_builddir}/google-auth-1.20.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1596512115
...
cp %{_builddir}/google-auth-1.20.0/LICENSE %{buildroot}/usr/share/package-licenses/google-auth/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
